			...
			<div class="auto-container">
				<div class="row clearfix">
					<div class="column col-lg-6 col-md-6 col-sm-12"> 
						<div class="footer-logo"><a href="index.html"><img src="{{asset("storage/".app_setting('site.logo_white'))}}" width="300" alt="" title=""></a></div>
					</div>
					<div class="column col-lg-6 col-md-6 col-sm-12">
						<!-- Subscribe Box -->
						<div class="subscribe-box">
							<form method="post" action="{{route('subscribe')}}">
								...
								<div class="form-group">
									<input type="email" name="search-field" value="" name="email" placeholder="ادخل البريد الالكتروني" required>
...
<div class="icon-float icon-float-call">
	<a class="float" href="tel:0501543950" target="_blank" data-kmt="1">
	<i class="fa fa-phone" style="color: white;margin-top: 20px;font-size: 30px;"></i>
	</a>
	</div>
<script> var url = 'https://widget.bot.space/js/widget.js'; var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = url; var options = {"enabled":true,"chatButtonSetting":{"backgroundColor":"#13C656","ctaText":"","borderRadius":"25","marginLeft":"20","marginBottom":"20","marginRight":"20","position":"left"},"brandSetting":{"brandName":"alnukbah","brandSubTitle":"","brandImg":"https://alnukbah.com//storage/app/public/settings/February2024/ylHxRo1DgF1gBWJfiZ1w.png","welcomeText":"مرحبا بك \nنحن بانتظار تواصلك معنا","messageText":"","backgroundColor":"#085E54","ctaText":"Start Chat","borderRadius":"25","autoShow":false,"phoneNumber":"00966501543950"}}; s.onload = function() { CreateWhatsappChatWidget(options); }; var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(s, x); </script>
</body>
