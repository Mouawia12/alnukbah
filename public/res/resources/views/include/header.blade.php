...
<div class="page-wrapper" dir="rtl">
	...
	<header class="main-header">
			...
			<div class="auto-container">
				<div class="inner-container">
					<div class="d-flex justify-content-between align-items-center flex-wrap" >
						...
						<div class="logo-box">
							<div class="logo"><a href="{{route('/')}}"><img src="{{asset("storage/app/public/".app_setting('site.logo_white'))}}"  alt="" title="" class="marginlogo"></a></div>
							<div class="logo-2"><a href="{{route('/')}}"><img src="{{asset("storage/app/public/".app_setting('site.big_logo'))}}"  alt="" title=""  class="marginlogo2"></a></div>
						</div>
		...
		<div class="mobile-menu">
			...
			<nav class="menu-box">
				<div class="nav-logo"><a href="{{route('/')}}"><img src="{{asset("storage/app/public/".app_setting('site.logo_white'))}}" width="300" alt="" title=""></a></div>
