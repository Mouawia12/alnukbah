                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @foreach($actions as $action)
                                                ...
                                                @endif
                                            @endforeach
                                            <a href="{{ url("admin/subservices?id=$idddd") }}" style="margin-left: 5px;" title="subservices" class="btn btn-sm btn-success pull-right view">
                                                <i class="voyager-info-circled"></i> <span class="hidden-xs hidden-sm">الخدمات الفرعية</span>
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
